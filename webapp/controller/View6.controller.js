sap.ui.define([
    ...
    return Controller.extend("cos.qmc.views.qmcviewdemo.controller.View6", {
        onNavBack: function () {
        ...
        onMaterialValueHelpRequest: function () {
            ...
            if (!this._oSelectDialog) {
                this._oSelectDialog = sap.ui.xmlfragment(oView.getId(), "cos.qmc.views.qmcviewdemo.view.fragments.MaterialValueHelpView6", this);
